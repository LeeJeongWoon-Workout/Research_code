...
for network in params['network']:
    ...
    for dataset in params['dataset']:
        base_path = join('../../../Users/AIRLAB/Downloads/DCFNet_pytorch-master/DCFNet_pytorch-master/track/dataset', dataset)
        json_path = join('../../../Users/AIRLAB/Downloads/DCFNet_pytorch-master/DCFNet_pytorch-master/track/dataset', dataset + '.json')
