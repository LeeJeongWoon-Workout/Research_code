...
class SAMC8_C4:
    ...
    def update_model(self,a,b,w):
        ...
        (q1,q1_target,q1_optim),(q2,q2_target,q2_optim),(q3,q3_target,q3_optim),(q4,q4_target,q4_optim)=random.sample(self.q_lst,4)
        ...
        q3_loss = a * L_avg.detach() + b * F.smooth_l1_loss(q3(state, action), target3.detach()) + w * F.smooth_l1_loss(q3(state, action), q_avg.detach())
        q4_loss = a * L_avg.detach() + b * F.smooth_l1_loss(q4(state, action), target4.detach()) + w * F.smooth_l1_loss(q4(state, action), q_avg.detach())
