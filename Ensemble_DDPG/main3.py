...
if __name__ == "__main__":
    ...
    for i in tqdm.trange(epoch):
        ...
        # Reward_list
        result1 = agent1.train(num_frames,a=0.5,b=0.5,w=0.01)
        result2 = agent1.train(num_frames, a=0.5, b=0.5, w=0.01)
        result3 = agent1.train(num_frames, a=0.5, b=0.5, w=0.01)
        result4 = agent1.train(num_frames, a=0.5, b=0.5, w=0.01)
